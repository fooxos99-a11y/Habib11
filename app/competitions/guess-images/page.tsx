          ...
          <>
            ...
            <div className="flex w-full max-w-7xl justify-between items-center mb-2 px-8">
              <div className="flex flex-col items-center">
                ...
                <div className="bg-[#d8a355] text-white rounded-lg px-4 py-2 text-xl font-extrabold w-full text-center shadow mt-2">{team2Score} نقطة</div>
              </div>
              <div className="flex flex-col items-center">
                ...
                <div className="bg-[#d8a355] text-white rounded-lg px-4 py-2 text-xl font-extrabold w-full text-center shadow mt-2">{team1Score} نقطة</div>
              </div>
            </div>
            {/* السبورة */}
                  ...
                  <DialogContent showCloseButton={false} className="max-w-md">
                    <DialogHeader>
                      <DialogTitle className="text-2xl text-center">الإجابة</DialogTitle>
                        <div className="text-lg text-[#1a2332] font-semibold mb-2">اكتشف معنى الصورة قبل الفريق الآخر</div>
                    </DialogHeader>
                ...
                <div className="max-w-2xl w-full bg-white rounded-2xl shadow-2xl p-6 sm:p-12 border-2 border-[#d8a355]/30 text-center flex flex-col items-center">
                  ...
                  {team1Score === team2Score ? (
                    ...
                    <>
                      ...
                      <div className="text-2xl font-bold text-[#1a2332] mb-4">{(team1Score === team2Score ? team1Score : Math.max(team1Score, team2Score)).toLocaleString()} نقطة</div>
                    </>
                  )}
